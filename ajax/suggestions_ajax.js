      ...
      $.ajax({
        ...
        success: function (result) {
          ...
          if (result.success) {
            ...
            setTimeout(function () {
              window.location.href = '../../pages/suggestions/list.php';
            }, 300);
          }
        },
          ...
          if (result.success) {
            ...
            $.each(daftar, function (i, data) {
              ...
              html += `<tr>
                            ...
                            <td>` + data.SuggestionStatus + `</td>
                            <td>` + data.AdminComments + `</td>
                            <td>
                            <a href="add.php?id=`+ data.SuggestionsID + `" class="btn btn-primary edit">
                             <span class="fas fa-pencil-alt"></span>
                            </a>
                            <button type="button" class="btn btn-danger delete" data-id="`+ data.SuggestionsID + `" >
