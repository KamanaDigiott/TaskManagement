      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Carwash Appointment</a></li>
...
<input type="hidden" name="user_id" id="user_id">
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="input-group mb-3 col-sm-6">
                  <div class="col-sm-6"><b>Service Type :</b></div>
                  <div class="col-sm-6"><span id="parktype"></span></div>
                </div>
                <div class="input-group mb-3 col-sm-6">
                  <div class="col-sm-6"><b>Mileage Readingon Servie :</b></div>
                  <div class="col-sm-6"><span id="addtnotes"></span></div>
                </div>
                <div class="input-group mb-3 col-sm-6">
                  <div class="col-sm-6"><b>Next Service Mileage :</b></div>
                  <div class="col-sm-6"><span id="manualadd"></span></div>
                </div>
                <div class="input-group mb-3 col-sm-6">
                  <div class="col-sm-6"><b>Last Oil Changed :</b></div>
                  <div class="col-sm-6"><span id="bookplace"></span></div>
                </div>
                <div class="input-group mb-3 col-sm-6">
                  <div class="col-sm-6"><b>Next Oil Change :</b></div>
...
?>
<!-- <script src="../../ajax/carservicebooking_ajax.js"></script>
 -->
<script>
    ...
    $.ajax({
      ...
      success: function(result) {
        if (result.success) {
          ...
          $('#service').html(bookingRec.ServiceTypeID).attr("selected", "selected");
          $('#status').val(bookingRec.BookingStatus).attr("selected", "selected");
          $('#booklocation').html(bookingRec.Location);
          $('#bookdate').html(bookingRec.BookingDate);
          $('#booktime').html(bookingRec.BookingTime);
          $('#parktype').html(bookingRec.ServiceType);
          $('#addtnotes').html(bookingRec.MileageReadingonServie);
          $('#manualadd').html(bookingRec.NextServiceMileage);
          $('#bookplace').html(bookingRec.LastOilChanged);
          $('#usedealcode').html(bookingRec.NextOilChange);
