      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Tyre Service Booking</a></li>
        ...
        <div class="register-box" style="width: 80%;">
          <div class="card card-outline card-primary">
            <div class="card-header text-center">
              <a href="#" class="h1"><b>Tyre Service Booking</b></a>
            </div>
            <div class="card-body">
              ...
              <form id="myForm" name="myForm" method="post">
                <div class="row">
                  ...
                  <div class="input-group mb-3 col-sm-6">
                    <input type="text" id="tyresize" name="tyresize" class="form-control" placeholder="Enter Tyre Size">
                    <div class="input-group-append">
                      <div class="input-group-text">
                        <span class="fas fa-user"></span>
                      </div>
...
?>
<script src="../../ajax/tyre_ajax.js"></script>
<script>
                ...
                $.ajax({
                  ...
                  success: function(result) {
                    if (result.success) {
                      ...
                      $('#tyresize').val(bookingRec.TyreSize);
