...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Car Service Type</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Car Service  Type Management</a></li>
            <li class="breadcrumb-item active">Add Car Service  Type</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
          ...
          <div class="card card-outline card-primary">
            ...
            <div class="card-body">
              ...
              <form id="myForm" name="myForm" method="post">
                ...
                <div class="input-group mb-3">
                  <input type="text" id="description" name="description" class="form-control" placeholder="Enter Car Service Type Description">
                  <div class="input-group-append">
                    <div class="input-group-text">
                ...
                <div class="row">
                  ...
                  <!-- /.col -->
                  <div class="col-4">
                    <input type="submit" id="save" class="btn btn-primary btn-block" value="Add Car service Type" />
                  </div>
                  <!-- /.col -->
                </div>
              </form>
...
?>
<script src="../../ajax/carservicetype_ajax.js"></script>
<script>
      ...
      $.ajax({
        ...
        success: function(result) {
          if (result.success) {
            ...
            $('#save').val('Update Car Service Type');
          }
        }
      });
    }
