      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Battery Service Booking</a></li>
            ...
            <div class="card-body">
              ...
              <form id="myForm" name="myForm" method="post">
                <div class="row">
                  ...
                  <div class="input-group mb-3 col-sm-6">
                    <select id="type" name="type" class="form-control" placeholder="Select service">
                ...
                $.ajax({
                  ...
                  success: function(result) {
                    if (result.success) {
                      ...
                      $('#type').val(bookingRec.BatterytypeID).attr("selected", "selected");
