...
<input type="hidden" name="user_id" id="user_id">
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="input-group mb-3 col-sm-6">
                  <div class="col-sm-6"><b>Parking Type :</b></div>
    ...
    $.ajax({
      ...
      success: function(result) {
        if (result.success) {
          ...
          $('#parktype').html(bookingRec.ParkingType);
          $('#addtnotes').html(bookingRec.AdditionalNotes);
          $('#manualadd').html(bookingRec.ManualAddress);
          $('#bookplace').html(bookingRec.BookingPlaceType);
          $('#usedealcode').html(bookingRec.UsedDealCode);
