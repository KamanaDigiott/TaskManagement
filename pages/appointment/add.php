...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Carwash Booking</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Carwash Booking</a></li>
            ...
            <div class="card-body">
              ...
              <form id="myForm" name="myForm" method="post">
                <div class="row">
                  ...
                  <div class="input-group mb-3 col-sm-6">
                    <select id="service" name="service" class="form-control" placeholder="Select service">
                  ...
                  <div class="input-group mb-3 col-sm-6">
                    <input type="text" id="addtnotes" name="addtnotes" class="form-control" placeholder="Enter addtnotes">
                    <div class="input-group-append">
                      <div class="input-group-text">
                        <span class="fas fa-envelope"></span>
                      </div>
                  ...
                  <div class="input-group mb-3 col-sm-6">
                    <input type="text" id="manualadd" name="manualadd" class="form-control" placeholder="Enter manual address">
                    <div class="input-group-append">
                      <div class="input-group-text">
                        <span class="fas fa-envelope"></span>
                      </div>
                  ...
                  <div class="input-group mb-3 col-sm-6">
                    <input type="text" id="bookplace" name="bookplace" class="form-control" placeholder="Enter place type Home Or Work">
                    <div class="input-group-append">
                      <div class="input-group-text">
                        <span class="fas fa-envelope"></span>
                      </div>
                ...
                $.ajax({
                  ...
                  success: function(result) {
                    if (result.success) {
                      ...
                      $('#service').val(bookingRec.ServiceTypeID).attr("selected", "selected");
                      $('#booklocation').val(bookingRec.BookingLocation);
                      $('#bookdate').val(bookingRec.BookingDate);
                      $('#booktime').val(bookingRec.BookingTime);
                      $('#parktype').val(bookingRec.ParkingType);
                      $('#addtnotes').val(bookingRec.AdditionalNotes);
                      $('#manualadd').val(bookingRec.ManualAddress);
                      $('#bookplace').val(bookingRec.BookingPlaceType);
                      $('#usedealcode').val(bookingRec.UsedDealCode);
