...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Battery Type List</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Battery Type Management</a></li>
            <li class="breadcrumb-item active">Battery Type List</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
      ...
      <div class="row">
        ...
        <div class="col-md-12 head" >
          <div class="float-right pb-2">
            ...
            <a href="../excels/export.php?action=export_battery_type" class="btn btn-primary"><i class="fas fa-download"></i> Export</a>
          </div>
        </div>
